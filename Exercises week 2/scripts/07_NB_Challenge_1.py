...
opacityTransferFunction.AddPoint(0, 0.05)
opacityTransferFunction.AddPoint(0.3, 0.2)

colorTransferFunction = vtk.vtkColorTransferFunction()
colorTransferFunction.AddRGBPoint(0.0, 1.0, 0.0, 0.0)
colorTransferFunction.AddRGBPoint(0.15, 0.0, 0.0, 0.2)
colorTransferFunction.AddRGBPoint(0.3, 0.0, 1.0, 0.0)
#colorTransferFunction.AddRGBPoint(0.03, 0.5, 0.0, 1.0)
#colorTransferFunction.AddRGBPoint(0.04, 0.0, 1.0, 0.0)
#colorTransferFunction.AddRGBPoint(0.5, 1.0, 0.0, 0.5)
